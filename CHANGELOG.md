...
- Added `successSegments` and `failureSegments` to microsite registration forms

## [2.0.2] - 2026-03-04

### Added

- Added email JSON content

## [2.0.1] - 2025-10-22

### Added

- Added branding config for widgets and microsite
...
[2.0.3]: https://github.com/saasquatch/schema/releases/tag/v2.0.3
[2.0.2]: https://github.com/saasquatch/schema/releases/tag/v2.0.2
[2.0.1]: https://github.com/saasquatch/schema/releases/tag/v2.0.1
